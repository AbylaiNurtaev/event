            ...
            <div className={s.innerContainer}>
                ...
                <div className={s.mainInformation}>
                    <div className={s.block}>
                        ...
                        <div className={s.selectWrapper}>
                            {
                                nominations &&
                                <select value={nomination} disabled={true} onChange={(e) => handleChange(e, setNomination)}>
                                    {
                    ...
                    <div className={s.block}>
                        ...
                        <div className={s.selectWrapper}>
                            <select value={specialization} disabled={true} onChange={(e) => handleChange(e, setSpecialization)}>
                    ...
                    <div className={s.block}>
                        ...
                        <input type="text" disabled={true} value={fullName} onChange={(e) => handleChange(e, setFullName)} />
                    </div>
                    <div className={s.block}>
                        <p>Город: <span>*</span> {false && <span><br />заполните обязательное поле *</span>}</p>
                        <input type="text" disabled={true} value={city} onChange={(e) => handleChange(e, setCity)} />
                    </div>
                    <div className={s.block}>
                        ...
                        <input type="file" disabled={true} id='logo-upload' accept='image/*' hidden={true} onChange={(e) => handleFileUpload(e, setLogo, 'logo')} />
                    </div>
                    <div className={s.block}>
                        ...
                        <input type="file" disabled={true} id='photo-upload' accept='image/*' hidden={true} onChange={(e) => handleFileUpload(e, setPhoto, 'avatar')} />
                    </div>
                    <div className={s.block}>
                        <p>Сайт: <span>*</span> {false && <span><br />заполните обязательное поле *</span>}</p>
                        <input type="text" disabled={true} value={website} onChange={(e) => handleChange(e, setWebsite)} />
                    </div>
                    <div className={s.block}>
                    ...
                    <div className={s.block}>
                        ...
                        <input type="text" disabled={true} value={service} onChange={(e) => handleChange(e, setService)} />
                    </div>
                ...
                <div className={s.socialMedias}>
                    <div className={s.block}>
                        ...
                        <input disabled={true} value={instagram} onChange={(e) => handleChange(e, setInstagram)} type="text" />
                    </div>
                    <div className={s.block}>
                        <p>Ссылка на Youtube: </p>
                        <input disabled={true} value={youtube} type="text" onChange={(e) => handleChange(e, setYoutube)} />
                    </div>
                    <div className={s.block}>
                        <p>Ссылка на VK: </p>
                        <input disabled={true} value={vk} type="text" onChange={(e) => handleChange(e, setVk)} />
                    </div>
                    <div className={s.block}>
                        <p>Ссылка на TikTok: </p>
                        <div className={s.saveBlock}>
                            <input disabled={true} value={tiktok} type="text" onChange={(e) => handleChange(e, setTiktok)} />
                        </div>
                    </div>
                </div>
                ...
                <label className={s.photosBlock} htmlFor="portfolio">
                    ...
                    <input type="file" disabled={true} hidden={true} multiple id='portfolio' onChange={(e) => handleFileSelection(e, 0)} accept=".png, .jpg" />
  ...
  videos && videos.map((elem, index) =>
    <div className={s.videoBlock} key={index}>
      ...
      />
                    ...
                    <button className={s.addBtn} disabled={true} onClick={() => setNewVideos(prev => [...prev, ""])}><img src="/images/ph_plus-light 11.svg" alt="" />Добавить ссылку</button>
                </div>
                ...
                {additionalFields && 
                    ...
                    <div className={s.additionalFields} key={index}>
                        ...
                        <label className={s.photosBlock} htmlFor={`portfolio${index}`}>
                            <div className={s.boldText}>ФОТОГРАФИИ</div>
                            <input type="file" hidden={true} disabled={true} multiple id={`portfolio${index}`} onChange={(e) => handleFileSelection(e, `portfolio${index}`)} accept=".png, .jpg" />
                            <div className={s.inputBlock}>
                                <p>Перетащите или нажмите для загрузки фото</p>
                                <p>Ограничение не более 50 файлов весом по 2 MB (.png, .jpg)</p>
                            </div>
